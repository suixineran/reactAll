...
function App() {
    ...
    let routers = [
        ...
        // { path: '/page2/:id', exact: false, title: '二级路由2', component: PageDetail},
        // { path: '/page3/:id', exact: false, title: '二级路由3', component: PageDetail},
        // { path: '/page4/:id', exact: false, title: '二级路由4', component: PageDetail},
